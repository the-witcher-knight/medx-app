...
const initTestColumns = () => {
  ...
  return [
    ...
    columnHelper.accessor('doctor.fullName', {
      header: 'Bác sĩ',
      cell: (info) => info.getValue(),
    }),
    ...
    columnHelper.accessor('id', {
      header: '',
      cell: (info) => <ActionPopover path="/test-manage" id={info.getValue} />,
    }),
  ];
};
...
function TestManagement() {
  ...
  const { entities, loading, error } = useSelector((state) => state.testManagement);
