 ...
 */
export const fetchAll = createAsyncThunk('unit/fetchAll', async (criteria) => {
 ...
 * Create a unit
 */
export const createOne = createAsyncThunk('unit/createOne', async (values) => {
 ...
 * Fetch a unit
 */
export const fetchOne = createAsyncThunk('unit/fetchOne', async (id) => {
 ...
 * Update a unit
 */
export const updateOne = createAsyncThunk('unit/updateOne', async (values) => {
 ...
 * Delete a unit
 */
export const deleteOne = createAsyncThunk('unit/deleteOne', async (id) => {
