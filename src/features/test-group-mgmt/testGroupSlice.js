...
const apiURL = `${process.env.REACT_APP_API_URL}/TestGroup`;
 ...
 */
export const fetchAll = createAsyncThunk('testGroup/fetchAll', async (criteria) => {
 ...
 * Create a test group
 */
export const createOne = createAsyncThunk('testGroup/createOne', async (values) => {
 ...
 * Fetch a test group
 */
export const fetchOne = createAsyncThunk('testGroup/fetchOne', async (id) => {
 ...
 * Update a test group
 */
export const updateOne = createAsyncThunk('testGroup/updateOne', async (values) => {
 ...
 * Delete a test group
 */
export const deleteOne = createAsyncThunk('testGroup/deleteOne', async (id) => {
